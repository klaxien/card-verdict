...
export function HydrateFallbackComponent() {
    ...
    // 提供一个支持 dark/light 的主题，确保 Skeleton 颜色跟随
    ...
    return (
        <ThemeProvider theme={theme}>
            <CssBaseline/> {/* 应用背景和 Skeleton 的颜色变量 */}
            <Box
                role="status"
                aria-live="polite"
                sx={{
                    bgcolor: "background.default", // 现在会跟随暗色/亮色
                }}
            >
                <LinearProgress
                    color="primary"
                ...
                <Stack spacing={3} sx={{pt: 1, pb: 4}}>
                    ...
                    <Grid container display="flex" justifyContent="center"
                          sx={{paddingTop: '5em', paddingBottom: '0.5em'}}>
                                        ...
                                        >
                                            <CardContent sx={{flexGrow: 1}}>
                                                <Grid container spacing={2} alignItems="center"
                                                    ...
                                                    <Grid size="grow"
                                                          sx={{minWidth: 0, flexGrow: 1, overflow: "hidden"}}>
